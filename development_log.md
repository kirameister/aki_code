...
前回のログからだいぶ時間が経ったけれど、エンジンの方もできてきているので、こちらに色々と書いていこうと思う。
[百式漢直](https://oookaworks.seesaa.net/article/519241715.html)という配列では、複数の漢字を漢直の出力としているように理解できた。aki_code でも同じ考えを取り入れて良いかもしれない。例えば…
